...
def truckle(pyproject_path: str, wheel_file_name: str = None, platform_tag: str = None) -> str:
...
if __name__ == "__main__":
    ...
    plattag = None
    truckle('/Users/whowe/Documents/GitHub/mclbn256/pyproject.standalone.toml', platform_tag=plattag)
